...
pc=<path_to_grpc_cpp_plugin> ../proto/chat.proto` where you can find `<path_to_grpc_cpp_plugin>` with `which grpc_cpp_plugin`. Most likely you will need to get protoc and other stuff as well. I did this:
```
